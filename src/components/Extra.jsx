...
const Extra = ({title, id, eps}) => {
	...
	return (
		<motion.div key={id} ref={viewRef} className="my-7 m-auto lg:m-0 lg:mb-1 text-[#f5f5f5] w-[90%] lg:w-64 bg-slate-900 rounded-lg p-3" variants={variants} initial="hidden" animate={controls} whileHover={{scale: 1.05,}} whileTap={{scale: 1.05,}}>
