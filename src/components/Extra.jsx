...
const Extra = ({title, id, eps}) => {
	...
	return (
		<motion.div key={id} ref={viewRef} className="my-7 text-[#f5f5f5] w-[90%] m-auto bg-slate-900 rounded-lg p-3" variants={variants} initial="hidden" animate={controls} whileHover={{scale: 1.05,}} whileTap={{scale: 1.05,}}>
